...
git clone
<https://github.com/hyperpolymath/JuliaPackage-Reuse-Audit.jl.git> cd
...
toolbox create JuliaPackage-Reuse-Audit.jl-dev toolbox enter
JuliaPackage-Reuse-Audit.jl-dev \# Install dependencies manually
