...
This document describes the governance model for **JuliaPackage Reuse Audit.Jl**.

---

## Project Governance Model

JuliaPackage Reuse Audit.Jl follows a **Benevolent Dictator For Life (BDFL)** governance model.
