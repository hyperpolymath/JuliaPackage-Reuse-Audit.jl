...
`+JuliaPackage-Reuse-Audit.jl+` pattern. After cloning, replace them
...
|===
|Placeholder |Description |Example |Files
|`+JuliaPackage Reuse Audit.Jl+` |Human-readable project name
|`+My Project+` |SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md,
STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.guix,
devcontainer.json

|`+JuliaPackage-Reuse-Audit.jl+` |One-line description |`+A tool for X+`
|flake.guix

|`+JuliaPackage-Reuse-Audit.jl+` |Uppercase identifier (for Idris2
modules, C macros) |`+MY_PROJECT+` |ABI-FFI-README.md, src/abi/_.idr,
ffi/zig/_.zig

|`+juliapackage-reuse-audit+` |Lowercase identifier (for C symbols,
filenames) |`+my_project+` |ABI-FFI-README.md, ffi/zig/*.zig

|`+JuliaPackage-Reuse-Audit.jl+` |Repository name (slug) |`+my-project+`
...
|`+JuliaPackage-Reuse-Audit.jl+` |One-line project description
