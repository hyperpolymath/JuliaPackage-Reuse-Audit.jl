...
All placeholders in this template follow the `JuliaPackage-Reuse-Audit.jl` pattern.
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `JuliaPackage Reuse Audit.Jl` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.guix, devcontainer.json |
| `JuliaPackage-Reuse-Audit.jl` | One-line description | `A tool for X` | flake.guix |
...
| `JuliaPackage-Reuse-Audit.jl` | One-line project description | `FFI bridges between languages` | STATE.a2ml |
