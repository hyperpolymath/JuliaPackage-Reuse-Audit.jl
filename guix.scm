...
;;
;; Guix package definition for JuliaPackage-Reuse-Audit.jl
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace JuliaPackage-Reuse-Audit.jl and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/JuliaPackage-Reuse-Audit.jl")
  (synopsis "JuliaPackage-Reuse-Audit.jl")
